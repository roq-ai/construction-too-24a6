  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Construction Tool Rental - Empowering individuals with convenient access to construction tools from multiple outlets across the region. Your project, our equipment."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Construction Tool Rental - Empowering individuals with convenient access to construction tools from multiple outlets across the region. Your project, our equipment.`}
            </Text>
            <Box
