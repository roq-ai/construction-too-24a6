...
export function ToolListPage(props: ToolListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getTools({
        relations: ['company', 'rental_history.count', 'rental_request.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('company', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('rental_history', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'rental_history',
          header: 'Rental History',
          accessorKey: 'rental_history',
          cell: ({ row: { original: record } }: any) => record?._count?.rental_history,
        }
      : null,
